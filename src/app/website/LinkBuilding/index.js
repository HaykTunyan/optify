...
const WebsiteMetricsLinkBuilding = withLazy(import('components/WebsiteMetricsLinkBuilding'));
...
const LinkBuilding = () => {
  ...
  return (
    <Fragment>
      <Helmet>
        <title>{`${t('link_building')} | ${t('brand_name')}`}</title>
      </Helmet>
      <Container.BaseShadow className='xs:pt-6 xs:pb-6 lg:pt-6 lg:pb-10 xl:pb-8'>
        ...
        >
          ...
          <div className='pt-8' />
          <WebsiteMetricsLinkBuilding t={t} register={register} errors={errors} />
          <div className='pt-8' />
